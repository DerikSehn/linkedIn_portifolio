...
export default function ProfileStatus() {
  return (
    <div className="rounded-xl pt-28 z-0 relative w-full bg-zinc-50 border ">
        <img className='w-full z-0 top-0 absolute rounded-t-xl' src={capaImg} alt='capaImg'/>
        <img src={profileAvatar} alt='user settings' 
        className='absolute w-20 border-2 border-slate-100 top-8 -translate-x-1/2 left-1/2 rounded-full' />
        <section className='py-4'>

        <span className="block font-extrabold text-lg text-center">Derik B. Sehn</span>
