...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="bg-gray-300 p-4 py-8 h-[1750px] sm:h-[850px]">
      <div className="container mx-auto">
        <div className='grid content-center'>
        <h2 className="text-5xl font-semibold mb-4">Contato</h2>
        <p className='text-2xl'>Gostou? Nos envie uma mensagem</p>
        </div>
